...
class NonLocal {
  public:
    NonLocal() {
      ...
      _ballAprx = new BallApproximationML("../input/ML/model_quad_unstruct.ts", "../input/ML/model_tri.ts");
    };
    ~NonLocal() {
      delete _ballAprx;
    };

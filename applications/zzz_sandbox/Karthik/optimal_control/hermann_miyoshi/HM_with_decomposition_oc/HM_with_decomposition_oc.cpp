...
#define LIBRARY_OR_USER   1 //0: library; 1: user
   ...
   #include "HM_with_decomposition_oc.hpp"
...
int main(int argc, char** args) {
 ...
 // =========Mesh file - END ==================
  ...
  system_biharmonic_HM._assemble_function = NAMESPACE_FOR_BIHARMONIC_HM :: biharmonic_HM_with_decomposition_oc :: AssembleBilaplaceProblem_AD;
